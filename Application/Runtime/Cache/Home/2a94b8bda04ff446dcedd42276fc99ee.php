                    ...
                    <div class="top">
                        ...
                        <div class="you">
                            ...
                            <div class="center">
                                <div class="xing">
                                <!-- 实心星数量 -->
                                <?php $__FOR_START_25787__=0;$__FOR_END_25787__=$vores["shixinxing"];for($i=$__FOR_START_25787__;$i < $__FOR_END_25787__;$i+=1){ ?><img src="/-/Public/home/img/quanstart.png" style="width:13%;" alt=""><?php } ?>
                                <!-- 判断半个 星星 -->
                        <?php if($vores["bangexing"] == 1): ?><img src="/-/Public/home/img/ban.png" style="width:13%;" alt="">
                        <?php else: endif; ?>
                                <!-- 空心星数量 -->
                                <?php $__FOR_START_3544__=0;$__FOR_END_3544__=$vores["kongxinxing"];for($i=$__FOR_START_3544__;$i < $__FOR_END_3544__;$i+=1){ ?><img src="/-/Public/home/img/wu.png" style="width:13%;" alt=""><?php } ?>
