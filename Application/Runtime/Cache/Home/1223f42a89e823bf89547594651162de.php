                        ...
                        <div class="main">
                            ...
                            <?php if(is_array($zuizhongfood)): foreach($zuizhongfood as $key=>$vozuizhongfood): ?><div class="con">
                                    <div class="right-con con-active" >
                                        ...
                                        <!--     ["id"] => string(2) "59"
    ["cpmingch"] => string(15) "酸辣土豆丝"
    ["food_type"] => string(2) "14"
    ["mingch"] => string(12) "今日特价"
    ["kouwei"] => string(13) "清香,麻辣"
    ["logo"] => string(18) "/img/yuxiangrs.jpg"
    ["yuanjia"] => string(2) "30"
    ["shoujia"] => string(2) "20"
    ["danweimc"] => string(3) "份"
    ["dwid"] => string(1) "9"
                                            ...
                                            <div class="menu-txt">
                                                ...
                                                <div class="btn">
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <i style="display: inline-block;"><?php echo ($vofoodxq["foodnum"]); ?></i>
                                                        <button class="add">
                                                        <strong>
                                                            <img src="/-/Public/home/img/jiahao.png" alt="">
                                                        </strong>
