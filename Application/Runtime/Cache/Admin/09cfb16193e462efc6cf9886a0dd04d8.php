    ...
    <!-- 对应门店id -->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="" name="ename">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                是&nbsp;&nbsp;<input type="radio"  value="0" name="zhuangt" checked="checked">
                否&nbsp;&nbsp;<input type="radio"  value="1" name="status">
            </div>
        </div>
        <!-- <div class="row cl">
