...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add"  method="post" enctype="multipart/form-data" action="<?php echo U('Admin/User/update_member');?>">
        <span class="c-red">会员余额：<?php echo ($m_res["money"]); ?></span>
        
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>余额操作：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" style="width:200px" value=""  id="money" name="money"><span style="color:red">[正数为充值，负数为扣款]
                <input type="hidden" name="id" value="<?php echo ($m_res["id"]); ?>">
                </span>
            </div>
        </div>
