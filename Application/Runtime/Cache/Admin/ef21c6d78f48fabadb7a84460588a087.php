 ...
 array_pop($location); foreach ($location as $value) { echo $value['name']; ?>
    ...
    <div class="page-container">
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
            <a href="javascript:;" onclick="admin_add('添加类别','<?php echo U('Admin/Shoptype/add');?>','800','500')"
               class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加类别</a></span>
        ...
        <!-- <table class="table table-border table-bordered table-bg">
            ...
            <tr>
                ...
                <?php if(is_array($info["list"])): $i = 0; $__LIST__ = $info["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr class="text-c">
                        ...
                        <td class="td-manage">
                            <a href="javascript:;"
                               onclick="admin_add('编辑详情','<?php echo U('Admin/Jixing/edit', array('id' => $item['id']));?>'
                               ,'800','500')">
                                <i class="Hui-iconfont">&#xe6df;</i>
                            </a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a class="h-text-sc" id="<?php echo ($item["id"]); ?>"><i class="Hui-iconfont">&#xe6e2;</i></a>
                        </td>
        ...
        <table class="table table-border table-bordered table-bg table-hover table-responsive">
            ...
            <tbody>
                <?php if(is_array($res)): foreach($res as $key=>$vo): ?><tr class="text-c">
                            ...
                            <td class="td-status">
                            	<?php if($vo["zhuangt"] == 1 ): ?><span class="label label-success radius">有效</span>
								    <?php else: ?> 
                            		<span class="label label-danger radius">无效</span><?php endif; ?>
                            </td>
                            <td class="td-status"><?php echo ($vo["paix"]); ?></td>
                            <td class="td-manage">
                            <a href="javascript:;"
