...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" action="<?php echo U('Admin/Seat/add');?>" method="post" enctype="multipart/form-data">
    <!-- 对应门店id -->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                    <?php if(is_array($rescaipinlb)): foreach($rescaipinlb as $key=>$volb): ?><input type="radio" name="seat_type" value="<?php echo ($volb["id"]); ?>"> <?php echo ($volb["mingch"]); ?> &nbsp;&nbsp;&nbsp;<?php endforeach; endif; ?>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
            <!-- 最低人数 -->
                <select name="zuoweiren_kai" class="select" style="width: 15%;">
            ...
            <!-- 最高人数 -->
                <select name="zuoweiren_zhong" class="select" style="width: 15%;">
                    <option value="0">0</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
