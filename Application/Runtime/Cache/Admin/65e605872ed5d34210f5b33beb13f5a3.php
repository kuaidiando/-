        ...
        <table class="table table-border table-bordered table-bg table-hover table-responsive">
            ...
            <tbody>
                <?php if(is_array($user_info)): foreach($user_info as $key=>$one_info): ?><tr class="text-c">
                            ...
                            <td><?php echo ($one_info["nickname"]); ?></td>
                            <td><?php echo ($one_info["tel"]); ?></td>
                            <td><?php echo ($one_info["money"]); ?></td>

                            <td><img width = "50" height = "50" src="<?php echo ($one_info["photo"]); ?>" alt="无头像"></td>
                            ...
                            <?php else: ?>
                            <td>未知</td><?php endif; ?>
                            <?php if($one_info["openid"] == 'NULL'): ?><td>
                                <span class="label label-danger radius">
                            ...
                            <td class="td-manage" style="text-align: center;">
                                ...
                                <a style="margin-left: -8%;margin-right: 10%;" href="javascript:;"
                                 ...
                                 <a style="margin-left: -8%;margin-right: 10%;" href="javascript:;"
                                   onclick="admin_add('编辑会员账号:','<?php echo U('Admin/User/member', array('id' => $one_info["id"]));?>'
                                   ,'800px','500px')">
