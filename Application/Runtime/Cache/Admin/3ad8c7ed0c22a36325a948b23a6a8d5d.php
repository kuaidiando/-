...
<div id="iframe_box" class="Hui-article">
    ...
    <div>
        <span>
        分享设置<input id="fx" type="text"  name="fx" value="<?php echo ($fx); ?>">
        <span id="tj" style="background:rgb(255,174,0);color:white">确认修改</span>
        </span>
    </div>
</div>
    ...
    $('#tj').click(function(){
        var value = $('#fx').val();
                        $.ajax({
                            type:'POST',
                            dataType: 'json',
                            url:'<?php echo U("Admin/Yingxiao/fx_submit");?>',
                            data:{value:value},
