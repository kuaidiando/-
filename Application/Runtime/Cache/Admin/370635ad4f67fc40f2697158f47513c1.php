    ...
    <form class="form form-horizontal" id="form-article-add" action="<?php echo U('Admin/Authentica/edit');?>" method="post" enctype="multipart/form-data">
        ...
        <div style="margin-top: 2%;width: 87%;margin-left: 4%;background-color: #F7F7F7;">
            ...
            <div class="row cl">
                ...
                <!-- 判断该字段是否过期 -->
                <?php if($data[0][type_shijianshifouguoqi] == 2): ?><span style="color: red;"><b>营业执照过期</b></span><?php endif; ?>
            </div>
        ...
        <div style="margin-top: 2%;width: 87%;margin-left: 4%;background-color: #F7F7F7;">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2" style="width: 30%;">身份证有效期：</label>
                <label class="form-label col-xs-4 col-sm-2" style="text-align: left;width: 50%;"><?php echo ($data["0"]["caiwu_sfzyouq"]); ?></label>
            </div>
            <br>
        </div> 
        <div class="row cl">
