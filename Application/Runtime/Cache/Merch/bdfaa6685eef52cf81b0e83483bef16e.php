...
<div class="big">
    ...
    <div class="zhao">
        <div class="tet">
            <input type="" style="width: 41%;" placeholder="营业执照照片">
                <!-- 图片上传 -->
...
<div class="geren">
    ...
    <div class="zhao">
        <div class="tet">
            <input type="" style="width: 41%;" placeholder="许可证照片">
                <!-- 图片上传 -->
...
<div class="geren">
    ...
    <div class="zhao">
        <div class="tet">
            <input type="" style="width: 41%;" placeholder="身份证照片">
                <!-- 图片上传 -->
    ...
    <!-- <span id="submitadd">确认提交</span> -->
     ...
     <script type="text/javascript">
        ...
        $(document).on("click","#submitadd",function(){
            var ren_yingyezhizmingch = $("input[name='ren_yingyezhizmingch']").val();
            var ren_yingyezhizjingyingz = $("input[name='ren_yingyezhizjingyingz']").val();
            var ren_yingyehaoma = $("input[name='ren_yingyehaoma']").val();
            var ren_jingyingdizhi = $("input[name='ren_jingyingdizhi']").val();
            var ren_jingyingfanwei = $("input[name='ren_jingyingfanwei']").val();
            var ren_yingyelogo = $("input[name='ren_yingyelogo']").val();
            var ren_cyxukezhenghaom = $("input[name='ren_cyxukezhenghaom']").val();
            var ren_fuwuxukezhengfaren = $("input[name='ren_fuwuxukezhengfaren']").val();
            var ren_fuwuxukezhengdizhi = $("input[name='ren_fuwuxukezhengdizhi']").val();
            var ren_cyxukelogo = $("input[name='ren_cyxukelogo']").val();
            var faren_lianxiren = $("input[name='faren_lianxiren']").val();
            var faren_tel = $("input[name='faren_tel']").val();
            var faren_sfzzhengjianhao = $("input[name='faren_sfzzhengjianhao']").val();
            var faren_sfzyouq = $("input[name='faren_sfzyouq']").val();
            var faren_sfzzheng = $("input[name='faren_sfzzheng']").val();
            if (ren_yingyezhizmingch && ren_yingyezhizjingyingz && ren_yingyehaoma && ren_jingyingdizhi && ren_jingyingfanwei && ren_yingyelogo && ren_cyxukezhenghaom && ren_fuwuxukezhengfaren && ren_fuwuxukezhengdizhi && ren_cyxukelogo && faren_lianxiren && faren_tel && faren_sfzzhengjianhao &&
                faren_sfzyouq && faren_sfzzheng) {
