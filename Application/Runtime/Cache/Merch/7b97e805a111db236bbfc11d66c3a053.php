...
<head>
    ...
    <link rel="stylesheet" href="/kuaidian/Public/merch/css/guanlifenlei.css">
    ...
    <div class="header">
        <div class="head">
            <?php if(is_array($resft)): foreach($resft as $key=>$voresft): ?><div class="top">
                    ...
                    <div class="topy">
                        <div class="kuang">
                            <a href="<?php echo U('Merch/Foodhoutai/addfood',array('shopid'=>$shopid,'foodtypeid'=>$voresft[id]));?>"><span>新建商品</span></a>
                        </div>
                    </div>
