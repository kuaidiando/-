...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function createXml()
	{
	   	...
	   	$this->parameters["appid"] = C('WX_CONFIG.APPID');//公众账号ID
	   	//$this->parameters["mch_id"] = WxPayConf_pub::MCHID;//商户号
	   	$this->parameters["mch_id"] = C('WX_CONFIG.MCHID');//商户号
...
{	
	function __construct() 
	{
		...
		$this->curl_timeout = C('WX_CONFIG.CURL_TIMEOUT');
	}
...
class NativeCall_pub extends Wxpay_server_pub
{
	...
	function createXml()
	{
		if($this->returnParameters["return_code"] == "SUCCESS"){
		   	...
		   	$this->returnParameters["appid"] = C('WX_CONFIG.APPID');//公众账号ID
		   	//$this->returnParameters["mch_id"] = WxPayConf_pub::MCHID;//商户号
		   	$this->returnParameters["mch_id"] = C('WX_CONFIG.MCHID');//商户号
...
class JsApi_pub extends Common_util_pub
{
	...
	public function getParameters()
	{
		...
		$jsApiObj["appId"] = C('WX_CONFIG.APPID');
		$timeStamp = time();
